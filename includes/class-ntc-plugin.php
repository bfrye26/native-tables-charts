...
final class NTC_Plugin {
	...
	public function register_assets_and_blocks(): void {
		...
		wp_add_inline_script('ntc-block-editor','window.NTC_EDITOR='.wp_json_encode(array(
	...
	public function invalidate_usage_cache(): void { delete_transient('ntc_dataset_usage_counts'); }
	public function block_category(array $categories,$context): array {array_unshift($categories,array('slug'=>'ntc-data','title'=>__('Data & Visualizations','native-tables-charts'),'icon'=>'chart-bar'));return $categories;}
}
